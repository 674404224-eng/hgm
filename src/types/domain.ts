...
export type TaskParameters = components["schemas"]["TaskParameters"];
export type TaskError = components["schemas"]["TaskError"];
export type TaskResult = components["schemas"]["TaskResult"];
export type TaskResultItem = components["schemas"]["TaskResultItem"];
